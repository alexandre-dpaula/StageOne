      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-block bg-primary hover:bg-primary-500 text-foreground px-6 py-3 rounded-lg font-semibold transition-colors"
          >
            + Criar Novo Evento
          </Link>
        </div>
        ...
        {myEvents && myEvents.length > 0 ? (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Link
                        ...
                        className="px-4 py-2 bg-primary hover:bg-primary-500 text-foreground rounded-lg text-sm transition-colors"
                      >
                        Check-in
                      </Link>
                    </div>
          ...
          <div className="bg-card rounded-lg p-12 text-center">
            ...
            <Link
              href="/painel/palestrante/eventos/novo"
              className="inline-block bg-primary hover:bg-primary-500 text-foreground px-6 py-3 rounded-lg transition-colors"
            >
