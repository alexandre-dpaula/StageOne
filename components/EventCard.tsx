      ...
      <div className="relative overflow-hidden rounded-2xl glass border border-border/30 hover:border-primary/30 transition-all duration-300 hover:shadow-glow-sm">
        ...
        <div className="p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-placeholder">{formatDate(event.start_datetime)}</span>
          </div>
          ...
          {event.subtitle && (
            <p className="text-sm text-placeholder line-clamp-1">{event.subtitle}</p>
          )}

          <div className="flex items-center justify-between mt-3 pt-3 border-t border-border/30">
            <span className="text-xs text-placeholder">A partir de</span>
            <span className="text-primary font-bold">R$ 99</span>
          </div>
        </div>
      </div>
    </Link>
